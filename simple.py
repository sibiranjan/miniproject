...
def Diabetes_diet():
    ...
    diabetescat = dataTog.iloc[[0,1,2,7,8,10]]
    diabetescat=diabetescat.T

    
    diabetescatDdata=diabetescat.to_numpy()
    
    diabetescat=diabetescatDdata[1:,0:len(diabetescatDdata)]
    
   
    diabetescatfin=np.zeros((len(diabetescat)*5,8),dtype=np.float32)
    t=0
    r=0
    s=0
    yt=[]
    ...
    ys=[]
    for zz in range(5):
        for jj in range(len(diabetescat)):
            valloc=list(diabetescat[jj])
            valloc.append(bmicls[zz])
            valloc.append(agecls[zz])
            diabetescatfin[t]=np.array(valloc)
            yt.append(brklbl[jj])
            t+=1
        for jj in range(len(diabetescat)):
            valloc=list(diabetescat[jj])
            valloc.append(bmicls[zz])
            valloc.append(agecls[zz])
            diabetescatfin[r]=np.array(valloc)
            yr.append(lnchlbl[jj])
            r+=1
        for jj in range(len(diabetescat)):
            valloc=list(diabetescat[jj])
            valloc.append(bmicls[zz])
            valloc.append(agecls[zz])
            diabetescatfin[s]=np.array(valloc)
            ys.append(dnrlbl[jj])
            s+=1
    X_test=np.zeros((len(diabetescat),8),dtype=np.float32)
...
def Thyroid_diet():
    ...
    thyroidcat = dataTog.iloc[[0,3,4,5,6,7]]
    thyroidcat=thyroidcat.T

    
    thyroidcatDdata=thyroidcat.to_numpy()
    
    thyroidcat=thyroidcatDdata[1:,0:len(thyroidcatDdata)]
    
   
    thyroidcatfin=np.zeros((len(thyroidcat)*5,8),dtype=np.float32)
    t=0
    r=0
    s=0
    yt=[]
    ...
    ys=[]
    for zz in range(5):
        for jj in range(len(thyroidcat)):
            valloc=list(thyroidcat[jj])
            valloc.append(bmicls[zz])
            valloc.append(agecls[zz])
            thyroidcatfin[t]=np.array(valloc)
            yt.append(brklbl[jj])
            t+=1
        for jj in range(len(thyroidcat)):
            valloc=list(thyroidcat[jj])
            valloc.append(bmicls[zz])
            valloc.append(agecls[zz])
            thyroidcatfin[r]=np.array(valloc)
            yr.append(lnchlbl[jj])
            r+=1
        for jj in range(len(thyroidcat)):
            valloc=list(thyroidcat[jj])
            valloc.append(bmicls[zz])
            valloc.append(agecls[zz])
            thyroidcatfin[s]=np.array(valloc)
            ys.append(dnrlbl[jj])
            s+=1
    X_test=np.zeros((len(thyroidcat),8),dtype=np.float32)
...
Label(main_win,text="Weight [Kg] ",font='Helvetica 12 bold').grid(row=2,column=0,sticky=W,pady=4)
Label(main_win,text="Height [In Meter] ", font='Helvetica 12 bold').grid(row=3,column=0,sticky=W,pady=4)
...
Button(main_win,text='Diabetes Diet',font='Helvetica 8 bold',command=Diabetes_diet).grid(row=1,column=5,sticky=W,pady=4)
Button(main_win,text='Thyroid Diet',font='Helvetica 8 bold',command=Thyroid_diet).grid(row=2,column=5,sticky=W,pady=4)
